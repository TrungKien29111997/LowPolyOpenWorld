...
public static class Constant
{
    ...
    public const string SCENE_UI = "UIScene";
    ...
    public const string EVENT_CHANGE_EQUIPMENT_RESOURCE = "EVENT_CHANGE_EQUIPMENT_RESOURCE";
    public const string EVENT_CHANGE_ARTIFACT_RESOURCE = "EVENT_CHANGE_ARTIFACT_RESOURCE";
    ...
    public const string ADDRESSABLES_LABEL_ARTIFACT_SO = "ArtifactSO";
    public const string ADDRESSABLES_LABEL_UI_PREFAB_SO = "UIPrefab";
    public const string RESORUCE_CODE_COMMON_RESOURCE = "CMR";
    public const string RESORUCE_CODE_EQUIPMENT_RESOURCE = "EQM";
    public const string RESORUCE_CODE_ARTIFACT_RESOURCE = "AIT";
